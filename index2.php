...
/*background: url('http://192.168.100.5/ShieldTheme/data1/images/youtube-icon2.png') no-repeat;
    width: 36px;
    height: 45px;
    opacity: 0.7;*/
   /* opacity: 1 ;*/
  ...
  <body data-spy="scroll" data-offset="0" data-target="#navbar-main">
	...
	<div class="ws_images"><ul>
		<li><img src="data1/images/cem_fb_contacto01.jpg" alt="CEM fb Contacto-01" title="CEM fb Contacto-01" id="wows1_0"/></li>
		<li><a href="http://wowslider.com"><img src="data1/images/gestion_huamana_fb01.jpg" alt="bootstrap slider" title="GestioÌn Huamana fb-01" id="wows1_1"/></a></li>
		<li><img src="data1/images/ito01.jpg" alt="ITO-01" title="ITO-01" id="wows1_2"/></li>
	</ul></div>

           <div class="ws_script" style="position:absolute;left:-99%"><a href="#">wowslider</a> by WOWSlider.com v8.7</div>
	             <div class="ws_shadow"></div>

	
	    <!--<ul class="barr">
	    	<li><a href="#"><img src="data1/images/Boton Web Casa-01.png" style="height:100px;width:120px;"></a></li>
	    	<li><a href="#"><img src="data1/images/Boton Youtube-01.png" style="height:100px;width:120px;"></a></li>
	    </ul>-->

	       <div class="redes">
	    	
	    	
	    	     <a href=" https://www.youtube.com/channel/UC5s6ug0V2YtCtslk7gzfGow" target="_blank" class="youtube" ><img src="data1/images/youtube-icon2.png"></a>
	    	     <a href="http://bio.com.pe/"  target="_blank" class="youtube"><img src="data1/images/unnamed.png"></a>
	      </div>


			<div class="row" >
			<br>
				<h1 class="centered">¡ Escríbenos y solicita más información ! </h1>
				...
				<div class="col-lg-6">
					...
					<span class="icon icon-phone"></span> (511) 364-8187  <br/><br/>
					<span class="icon icon-home"></span> Av. La Encalada N° 948<br/>
					...
					Santiago - Chile<br/>
					Cerro Colorado N°5858, oficina 207 - Las Condes
					<br/>
					<br/>

					Bogotá - Colombia<br/>
					Calle 67 8-12 Of 602

					<br/>
					<br/>

					Guayaquil - Ecuador<br/>
					Bálsamos 118 y Calle Única Urdesa

					
					</p>

					<!--<span class="icon icon-home"></span> Some Address 987, NY<br/>-->
						<!--<span class="icon icon-phone"></span> (511) 364-8187 <br/>-->
					...
					<p>-->
						<form class="form-horizontal" role="form">
						  ...
						  <div class="form-group">
						    <label for="nombre" class="col-lg-2 control-label" style="font-size:14px;">Nombre:</label>
						    <div class="col-lg-10">
						  ...
						  <div class="form-group">
						    <label style="font-size:14px;" for="apellido" class="col-lg-2 control-label">Apellido:</label>
						    <div class="col-lg-10">
						  ...
						  <div class="form-group">
						    <label style="font-size:14px;" for="telefono" class="col-lg-2 control-label">Teléfono:</label>
						    <div class="col-lg-10">
						  ...
						  <div class="form-group">
						    <label style="font-size:14px;" for="correo" class="col-lg-2 control-label">E-mail:</label>
						    <div class="col-lg-10">
						   ...
						   <div class="form-group">
						    <label style="font-size:14px;" for="servicio" class="col-lg-2 control-label">Servicios:</label>
						    <div class="col-lg-10">
						      <select class="form-control">
						      <option>Seleccione 
                                        </option>
                                       <option>Agentes Virtuales 
                                        </option>
                                       <option>Contact Center 
                                           </option>
                                       <option>Monitoreo de Gestión 
                                         </option>
                                       <option>Canales Digitales para Interacción con Clientes 
                                              </option>
                                       <option>Gestión de la Experiencia del Cliente 
                                        </option>
                                        <option>Software Integral de Gestión Humana 
                                          </option>
                                        <option>Evaluación de Puestos y Estructuras Salariales 
                                         </option>
                                        <option>Diseño de Sistemas de Remuneración Variable 
                                          </option>
                                           <option>Evaluación de Competencias 
                                            </option>
                                          <option>Descripción de Puestos
                                           </option>
                                           <option>Diseño de la Organización 
                                            </option>
                                              <option>Clima Organizacional  
                                                </option>
                                            <option>Desarrollo de Software 
                                           </option>

                                             <option>Plataformas de Contact Center 
                                              </option>
                                             <option>Plataformas de Gestión de Canales Digitales 
                                              </option>
                                               <option>Desarrollo de App
                                                </option>
						  ...
						  <div class="form-group">
						    <label  style="font-size:14px;" for="mensaje" class="col-lg-2 control-label">Mensaje:</label>
						    <div class="col-lg-10">
                         ...
                         <br>
                        <button type="submit" class="btn btn-primary" style="font-size:18px;">Enviar</button>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;; &nbsp; &nbsp; &nbsp;
                        <a class="btn btn-primary" style="font-size:18px;height:42px;" href="#">Cerrar</a>
                        <br>
                        <br>
...
<!--<div class="instuction">
	<p class="note">HTML code for the slider <a href="file:///D:/Users/usuario/Desktop/wwww/wowslider.html">D:/Users/usuario/Desktop/wwww/wowslider.html</a></p>
	...
	<ul>
		...
		<li class="note">Current location: <a href="file:///D:/Users/usuario/Desktop/wwww">D:/Users/usuario/Desktop/wwww</a>. <br>These folders should be located in the same folder as your html page</li>
	</ul>
...
&lt;div class=&quot;ws_images&quot;&gt;&lt;ul&gt;
		&lt;li&gt;&lt;img src=&quot;data1/images/cem_fb_contacto01.jpg&quot; alt=&quot;CEM fb Contacto-01&quot; title=&quot;CEM fb Contacto-01&quot; id=&quot;wows1_0&quot;/&gt;&lt;/li&gt;
		&lt;li&gt;&lt;a href=&quot;http://wowslider.net&quot;&gt;&lt;img src=&quot;data1/images/gestion_huamana_fb01.jpg&quot; alt=&quot;http://wowslider.net/&quot; title=&quot;GestioÌn Huamana fb-01&quot; id=&quot;wows1_1&quot;/&gt;&lt;/a&gt;&lt;/li&gt;
		&lt;li&gt;&lt;img src=&quot;data1/images/ito01.jpg&quot; alt=&quot;ITO-01&quot; title=&quot;ITO-01&quot; id=&quot;wows1_2&quot;/&gt;&lt;/li&gt;
	&lt;/ul&gt;&lt;/div&gt;
	&lt;div class=&quot;ws_bullets&quot;&gt;&lt;div&gt;
		&lt;a href=&quot;#&quot; title=&quot;CEM fb Contacto-01&quot;&gt;&lt;span&gt;&lt;img src=&quot;data1/tooltips/cem_fb_contacto01.jpg&quot; alt=&quot;CEM fb Contacto-01&quot;/&gt;1&lt;/span&gt;&lt;/a&gt;
		&lt;a href=&quot;#&quot; title=&quot;GestioÌn Huamana fb-01&quot;&gt;&lt;span&gt;&lt;img src=&quot;data1/tooltips/gestion_huamana_fb01.jpg&quot; alt=&quot;GestioÌn Huamana fb-01&quot;/&gt;2&lt;/span&gt;&lt;/a&gt;
		&lt;a href=&quot;#&quot; title=&quot;ITO-01&quot;&gt;&lt;span&gt;&lt;img src=&quot;data1/tooltips/ito01.jpg&quot; alt=&quot;ITO-01&quot;/&gt;3&lt;/span&gt;&lt;/a&gt;
