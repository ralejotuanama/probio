      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
           <li><a href="" class="smoothScroll" style="width:145px;height:70px;background: url('http://192.168.100.5/probio/data1/images/BIO sin texto-01.png');
    background-size: 130px 65px;
    background-repeat: no-repeat;"></a></li>
            <li><a href="#home" class="smoothScroll">Conócenos</a></li>
			<li> <a href="#about" class="smoothScroll">Servicios</a></li>
			<li> <a href="#services" class="smoothScroll">Clientes</a></li>
			<!--<li> <a href="#team" class="smoothScroll">Empresas</a></li>-->
			<li> <a href="#portfolio" class="smoothScroll">Novedades</a></li>
	   ...
	   <br> <br> <br>
	    ...
	    <div style="margin: 0 auto;" id="home" name="home">


<div id="wowslider-container1">
	<div class="ws_images"><ul>
		<li><img src="data3/images/primer_slider01.jpg" alt="Primer slider-01" title="Primer slider-01" id="wows1_0"/></li>
		<li><img src="data3/images/people_1.jpg" alt="People 1" title="People 1" id="wows1_1"/></li>
		<li><a href="http://wowslider.com"><img src="data3/images/people_5.jpg" alt="responsive slider" title="people 5" id="wows1_2"/></a></li>
		<li><img src="data3/images/people4.jpg" alt="people4" title="people4" id="wows1_3"/></li>
	</ul></div>
<div class="ws_script" style="position:absolute;left:-99%"><a href="http://wowslider.com/vi">image slider</a> by WOWSlider.com v8.7</div>
	<div class="ws_shadow"></div>
	   ...
	   <!--<div id="wowslider-container1">
	<div class="ws_images"><ul>
		<li><img src="data2/images/primer_slider01.jpg" alt="Primer slider-01" title="Primer slider-01" id="wows1_0"/></li>
		<li><img src="data2/images/people_1.jpg" alt="People 1" title="People 1" id="wows1_1"/></li>
		<li><a href="http://wowslider.com"><img src="data2/images/people_5.jpg" alt="wowslider" title="people 5" id="wows1_2"/></a></li>
		<li><img src="data2/images/people4.jpg" alt="people4" title="people4" id="wows1_3"/></li>
	</ul></div>
<div class="ws_script" style="position:absolute;left:-99%"><a href="http://wowslider.com/vi">image slider</a> by WOWSlider.com v8.7</div>
	<div class="ws_shadow"></div>
	</div>	-->
		...
		<div class="container" id="about" name="about" >
			<div class="row white" >
			<br>
				<h1 class="centered" style="color:#222F5B;">Unidades de Negocio</h1>
				
				 
				<div class="col-lg-offset-3 col-lg-6" >
				<!--<h3 style="text-align:center;">CEM</h3>-->
				<div style="text-align:center;">
					<!--<h5>abcd abcd</h5>-->
					<img src="data3/images/CEM123.png" style="width:150px;text-align:center;" />
				</div>

				
				<!--<img src="data3/images/Force-01.png" style="width:150px;text-align:center;" />-->
				<h6 style="text-align:center;color:#222F5B;font-weight:600">CUSTOMER EXPERIENCE MANAGEMENT</h6>


					<p style="text-align:center;color:#222F5B;font-weight:500">Agentes Virtuales<br>
					Contact Center<br>
					Monitoreo de Gestión<br>
					Canales Digitales para Interacción con Clientes<br>
					Gestión de la Experiencia del Cliente<br><br>
					<a style="color:black;font-weight:500" href="cem.php">Leer más</a>
				...
				<div style="text-align:center;">
					<!--<h5>abcd abcd</h5>-->
					<img src="data3/images/People-01.png" style="width:150px;text-align:center;" />
				</div>

				<!--<h3 style="text-align:center;">PEOPLE</h3>-->
				<h6 style="text-align:center;color:#222F5B;font-weight:600">BPO DE GESTIÓN HUMANA</h6>
					<p style="text-align:center;color:#222F5B;font-weight:500">Consultoría en Gestión Humana<br>
					Software Integral de Gestión Humana<br>
					Evaluación de Puestos y Estructuras Salariales<br>
					Canales Digitales para Interacción con Clientes<br>
					Diseño de Sistemas de Remuneración Variable<br>
					Evaluación de Competencias<br>
					Descripción de Puestos <br>
					Diseño de la Organización<br>
					Clima Organizacional<br><br>
					<a style="color:black;font-weight:500" href="people.php">Leer más</a>
					</p>
				...
				<h3  style="text-align:center;">DIGITO</h3>
				<h6 style="text-align:center;color:#222F5B;font-weight:600">INFORMATION TECHNOLOGY OUTSOURCING - ITO</h6>
					<p style="text-align:center;color:#222F5B;font-weight:500">Desarrollo de Software<br>
					Plataformas de Contact Center<br>
					Plataformas de Gestión de Canales Digitales<br>
					Desarrollo de App<br>
					Bussiness Intelligence<br><br>
					<a style="color:black;font-weight:500" href="digito.php">Leer más</a></p>
				...
				<h3 style="text-align:center;">FORCE</h3>
				<h6 style="text-align:center;color:#222F5B;font-weight:600">GESTIÓN DE CAMPO</h6>
					<p style="text-align:center;color:#222F5B;font-weight:500">Instalaciones<br>
					Servicios Técnicos<br>
					Ventas en Campo<br>
					Encuestas en Campo<br>
					Recupero de Equipos<br>
					Supervisión de Campo<br><br>
					<a style="color:black;font-weight:500" href="#">Leer más</a>
				</p>
